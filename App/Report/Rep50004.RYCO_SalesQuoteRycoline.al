report 50004 "Sales Quote Rycoline"
{
    // jl20180815 - add SETCURRENTKEY in SalesLine OnPreDataItem
    DefaultLayout = RDLC;
    RDLCLayout = './App/Layout-Rdl/Rep50004.RYCO_SalesQuoteRycoline.rdlc';
    ...
    labels
    {
        Fr_ReportHeader = ' / Devis de vente';
        Fr_SalesOrderNumber = 'N° de devis de vente :';
        Fr_SalesOrderDate = 'Date de devis de vente :';
        Fr_SoldTo = 'Vendu €€‡';
        Fr_ShipTo = 'Expédier ‡';
