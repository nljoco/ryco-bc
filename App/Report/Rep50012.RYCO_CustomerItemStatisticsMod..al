report 50012 "Customer/Item Statistics Mod"
{
    DefaultLayout = RDLC;
    RDLCLayout = './App/Layout-Rdl/Rep50012.RYCO_CustomerItemStatisticsMod.rdlc';
    ...
    begin
        ...
        */
        ...
        //////////////////////////////////////////////////////////////////////////////
        //begin add smk2018.04.18 slupg: replaces the above commented code
        //////////////////////////////////////////////////////////////////////////////
        ExcelBuf.AddInfoColumn(Format(Text003), false, true, false, false, '', ExcelBuf."Cell Type"::Text);
        ExcelBuf.AddInfoColumn(CompanyInformation.Name, false, false, false, false, '', ExcelBuf."Cell Type"::Text);
        ExcelBuf.NewRow;
