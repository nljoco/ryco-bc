report 50018 "YCO Phys. Inventory List"
{
    // smk2018.04.17 slupg - use the customized version of this report as-is:
    //   //FH20161118
    //     - Added New Field Shelf No. (New_ItemJournalLine_Shelf_No)
    //   nj20170201
    //   - removed Global Dimension 1, Global Dimension 2 and Bin Codes
    //   - removed Background Color
    //   - adjusted font size
    //   - increased width of Item No. and Description
    //   - added a line between item
    DefaultLayout = RDLC;
        ...
        dataitem(PageLoop; "Integer")
        {
            ...
            dataitem("Item Journal Batch"; "Item Journal Batch")
            {
                ...
                dataitem("Item Journal Line"; "Item Journal Line")
                {
                    ...
                    column(New_ItemJournalLine_Shelf_No; "Item Journal Line"."Shelf No.")
                    {
                    }
                    column(BaseUOM; gcodBaseUOM)
                    {
                    }
                    column(BaseUOMCaption; BaseUOMCaptionLbl)
                    {
                    }
                    ...
                    begin
                        ...
                        if grecItem.Get("Item No.") then
                            gcodBaseUOM := grecItem."Base Unit of Measure";
                        // nj20170201 - End
                    end;
                    ...
                    begin
                        // nj20170201 - Start
                        if (GetFilter("Location Code") = 'TORONTO') or (GetFilter("Location Code") = '') then
                            SetCurrentKey("Shelf No.", "Item No.")
                        else
    ...
    local procedure CreateReservEntry(ItemJournalLine: Record "Item Journal Line"; Qty: Decimal; SerialNo: Code[20]; LotNo: Code[20]; ItemTracking: Option "None","Lot No.","Lot and Serial No.","Serial No.")
    var
        FoundRec: Boolean;
    begin
