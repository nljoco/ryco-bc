report 50020 "RYCO Transfer Order"
{
    // smk2018.04.17 slupg - use the customized version of this report as-is
    DefaultLayout = RDLC;
    RDLCLayout = './App/Layout-Rdl/Rep50020.RYCO_TransferOrder.rdlc';

    Caption = 'Ryc Transfer Order';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Transfer Line"; "Transfer Line")
                    {
                        ...
                        column(Desc2_TransLine; "Description 2")
                        {
                        }
