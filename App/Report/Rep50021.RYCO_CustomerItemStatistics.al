report 50021 "RYCO Customer/Item Statistics"
{
    // ID2093 - add two fields "Purchase Qty. per Unit of Measure" and "Total KG Purchased"
    DefaultLayout = RDLC;
            ...
            dataitem("Value Entry"; "Value Entry")
            {
                ...
                begin
                    if ValueEntryTotalForItem."Item No." <> "Item No." then begin
                        ...
                        //ID2093 start
                        ItemUOM.Reset;
                        ItemUOM.SetFilter("Item No.", '%1', "Value Entry"."Item No.");
                        ItemUOM.SetFilter(Code, Item."Price Unit of Measure Code");
                        if ItemUOM.FindFirst then
                            Item_PUOM := ItemUOM."1 per Qty. per Unit of Measure"
                        else
                            Item_PUOM := 1;
                        //ID2093 end
    ...
    begin
        ...
        ExcelBuf.AddColumn('Total KG Purchased', false, '', true, false, true, '', ExcelBuf."Cell Type"::Text);
        //ID2093 end
    end;
    ...
    begin
        ...
        //ID2093 start
        ExcelBuf.AddColumn(Item_PUOM, false, '', false, false, false, '', ExcelBuf."Cell Type"::Number);
        ExcelBuf.AddColumn(-ValueEntryTotalForItem."Invoiced Quantity" * Item_PUOM, false, '', false, false, false, '', ExcelBuf."Cell Type"::Number);
        //ID2093 end
    end;
