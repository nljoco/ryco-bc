report 50022 "RYCO Purchase Order"
{
    // smk2018.04.17 slupg - use the customized version of this report as-is:
    //   ID516, nj20170117
    //   - added printing of Requested Receipt Date.
    //   ID618, nj20170217
    //   - adjusted width of Item No. to accomodate 20 chars.
    DefaultLayout = RDLC;
    RDLCLayout = './App/Layout-Rdl/Rep50022.RYCO_PurchaseOrder.rdlc';

    Caption = 'Ryc Purchase Order';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ReqRecDate_PurchaseHeader; "Purchase Header"."Requested Receipt Date")
                    {
                    }
                    ...
                    column(ReqRecDateCaption; ReqRecDateCaptionLbl)
                    {
                    }
    ...
    var
        ...
        ReqRecDateCaptionLbl: Label 'Requested Receipt Date';
}
