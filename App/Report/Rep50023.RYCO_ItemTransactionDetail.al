report 50023 "RYCO Item Transaction Detail"
{
    // smk2018.04.17 slupg - use the cusomized version of this report as-is
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                column(AssemblyOrderNo; gtxtAssemblyOrderNo)
                {
                }
                ...
                begin
                    ...
                    //FH20160921-->
                    gtxtAssemblyOrderNo := '';
                    if "Entry Type" in [8, 9] then begin  //Assembly Consumption, Assembly Output
                        if grecPostedAssemblyHeader.Get("Document No.") then begin
                            gtxtAssemblyOrderNo := grecPostedAssemblyHeader."Order No.";
                        end;
                    end;
                    //FH20160921--<
                end;
    ...
    labels
    {
        AssemblyOrderNoLbl = 'Assembly Order No.';
    }
    ...
    var
        ...
        gtxtAssemblyOrderNo: Text[20];
        grecPostedAssemblyHeader: Record "Posted Assembly Header";
}
