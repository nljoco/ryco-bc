report 50025 "RYCO Check (Stub/Check/Stub)"
{
    // smk2018.04.17 slupg: use modified report as-is
    //   jl20170316 clear company address
    DefaultLayout = RDLC;
    RDLCLayout = './App/Layout-Rdl/Rep50025.RYCO_CheckStubCheckStub.rdlc';

    Caption = 'Ryc Check (Stub/Check/Stub)';
